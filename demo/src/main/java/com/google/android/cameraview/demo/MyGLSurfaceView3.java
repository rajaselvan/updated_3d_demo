...
public class MyGLSurfaceView3 extends GLSurfaceView {
    ...
    @NonNull private MyGLRenderer3 renderer;
    ...
    public MyGLSurfaceView3(@NonNull Context context, @Nullable Model model) {
        super(context);
        setEGLContextClientVersion(2);
        setEGLConfigChooser(8, 8, 8, 8, 16, 0);
        getHolder().setFormat(PixelFormat.TRANSLUCENT);
        setZOrderOnTop(true);
        renderer = new MyGLRenderer3(model);
    ...
    public MyGLRenderer3 getRenderer() {
        return renderer;
    }
